...
#GeneticProgramming(N_Generations, inputs,population_size, depth, mutation_rate, desired_output)
#inputs = [8, 4,4,6,8,9]
#gp     = GeneticProgramming(40, inputs, 50, 3, 0.2, 594)
...
#print(inputs_multiply.shape)

#gp     = GeneticProgramming(300, inputs_power_sum, 300, 5, 0.2, None)


#best_individual, mean_fit_per_generation, worst_fit_per_generation, best_fit_per_generation = gp.run()
#print('testing best individual')

#print(best_individual.evaluate(inputs, False))
#print(best_individual.evaluate(inputs_power_sum[:, 1:].T, False))
#print(best_individual.print_tree())
#print(best_individual.print_order())

'''

trees = gp.generate_population()
...
print('\n')
print('tree fitness')
fitness = gp.fitness(trees)
print(fitness)
print('selected trees')
selected = gp.selection(trees, fitness)
for tree in selected:
    print(tree.print_tree())

print('\n')
print('sons')
sons = gp.cross_over(selected)
for son in sons:
    print(son.print_tree())

print(sons[0].print_levels())
gp.tree_factory.set_tree_levels(sons[0])
print(sons[0].print_levels())


print('\n')
print('mutated trees')
mutated_trees = gp.mutation(sons)

for amutated in mutated_trees:
    print(amutated.print_tree())
